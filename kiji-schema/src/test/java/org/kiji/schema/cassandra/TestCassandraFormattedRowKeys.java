...
public class TestCassandraFormattedRowKeys extends KijiClientTest {
  // TODO: Run these tests once C* Kiji supports scans over primary key ranges.
  /*
  private static final Logger LOG = LoggerFactory.getLogger(TestCassandraFormattedRowKeys.class);
