 ...
 */
@ApiAudience.Private
public final class CassandraInstallTool extends BaseTool {
  private static final Logger LOG = LoggerFactory.getLogger(CassandraInstallTool.class);

  @Flag(name="kiji", usage="URI of the Cassandra Kiji instance to install.")
  ...
  public String getName() {
    return "cassandra-install";
  }

  /** {@inheritDoc} */
  @Override
  public String getDescription() {
    return "Install a Kiji instance onto a running Cassandra cluster.";
  }
  ...
  protected void setup() throws Exception {
    ...
    Preconditions.checkArgument((mKijiURIFlag != null) && !mKijiURIFlag.isEmpty(),
        "Specify the Kiji instance to install with --kiji=kiji://cassandra-address/kiji-instance");
  ...
  protected int run(List<String> nonFlagArgs) throws Exception {
    ...
    getPrintStream().println("Creating meta tables for Kiji instance in Cassandra...");
  ...
  public static void main(String[] args) throws Exception {
    System.exit(new KijiToolLauncher().run(new CassandraInstallTool(), args));
  }
}
