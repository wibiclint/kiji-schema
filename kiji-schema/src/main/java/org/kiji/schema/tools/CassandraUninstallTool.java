 ...
 */
@ApiAudience.Private
public final class CassandraUninstallTool extends BaseTool {
  ...
  protected int run(List<String> nonFlagArgs) throws Exception {
    ...
    /* TODO: Need to add this double checking back!
    if (isInteractive())  {
  ...
  public static void main(String[] args) throws Exception {
    System.exit(new KijiToolLauncher().run(new CassandraUninstallTool(), args));
  }
}
