 ...
 * {@link KijiHTablePool(String, HTableInterfaceFactory). Note that the provided
 * HTableInterfaceFactory <i>must</i> return HTables rather than another implementation of
