...
@ApiAudience.Private
public final class CassandraKijiTableAnnotator implements KijiTableAnnotator {
   ...
   * private for testing.
   *
   * @param table KijiTable in which the specified column lives. This will be used for
   ...
   * @throws org.kiji.schema.NoSuchColumnException in case the column does not exist in the table.
   */
  static String getMetaTableKey(
   ...
   * KijiTableAnnotator meta table key. This method is package private for testing.
   *
   * @param table KijiTable in which the column from the specified key lives. This will be used
  ...
  /**
   * Initialize a new CassandraKijiTableAnnotator for the given table.
   *
   * @param table the table served by this ColumnAnnotator.
   */
  public CassandraKijiTableAnnotator(
      final CassandraKijiTable table
  ) {
    mTable = (CassandraKijiTable) table.retain();
  ...
  public void close() throws IOException {
    requireAndSetState(State.OPEN, State.CLOSED, "close a CassandraKijiTableAnnotator");
    mTable.release();
  }
   ...
   * @throws java.io.IOException in case of an error writing to the meta table.
   */
  private void setKV(
      final String metaTableKey,
      final String value
   ...
   * @throws java.io.IOException in case of an error reading from the meta table.
   */
   ...
   * @throws java.io.IOException in case of an error reading form the meta table.
   */
   ...
   *     translated.
   * @throws java.io.IOException in case of an error removing a defunct key.
   */
