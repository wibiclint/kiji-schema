 ...
 */
@ApiAudience.Private
public class CassandraQualifierIterator implements CloseableIterable<String>, Iterator<String> {
  /** Underlying qualifier pager. */
  private final CassandraQualifierPager mPager;
  ...
  public CassandraQualifierIterator(
    ...
    mPager = new CassandraQualifierPager(entityId, dataRequest, table, family);
