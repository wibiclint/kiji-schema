...
@ApiAudience.Private
public final class CassandraKijiTableReaderBuilder implements KijiTableReaderBuilder {

  /**
   * Create a new CassandraKijiTableReaderBuilder for the given CassandraKijiTable.
   *
   * @param table CassandraKijiTable for which to build a reader.
   * @return a new CassandraKijiTableReaderBuilder.
   */
  public static CassandraKijiTableReaderBuilder create(
      final CassandraKijiTable table
  ) {
    return new CassandraKijiTableReaderBuilder(table);
  }
  ...
  /**
   * Initialize a new CassandraKijiTableReaderBuilder for the given CassandraKijiTable.
   *
   * @param table CassandraKijiTable for which to build a reader.
   */
  private CassandraKijiTableReaderBuilder(
      final CassandraKijiTable table
  ) {
    mTable = table;
  }
  ...
  /** {@inheritDoc} */
  @Override
  public CassandraKijiTableReader buildAndOpen() throws IOException {
    ...
    return CassandraKijiTableReader.createWithOptions(
